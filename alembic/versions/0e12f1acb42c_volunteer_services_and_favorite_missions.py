...
def downgrade() -> None:
    ...
    """
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('volunteer', sa.Column('finished_missions_count', sa.INTEGER(), autoincrement=False, nullable=False))
    op.add_column('volunteer', sa.Column('active_missions_count', sa.INTEGER(), autoincrement=False, nullable=False))
