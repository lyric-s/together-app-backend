...
def get_all_ai_reports(
    *,
    ...
    """
    Retrieve all AI-generated reports.

    Returns a paginated list of all reports automatically generated by the AI
    moderation system, ordered by most recent first.
...
def update_ai_report_state(
    *,
    ...
    """
    Update AI report processing state (approve/reject).

    Allows admins to manually confirm or dismiss an AI-generated signalement.
