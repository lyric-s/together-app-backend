...
def load_models():
    ...
    if toxicity_pipeline and spam_model:
    ...
    try:
        ...
        spam_tokenizer = CamembertTokenizer.from_pretrained(spam_model_name)
        spam_model = CamembertForSequenceClassification.from_pretrained(spam_model_name)
